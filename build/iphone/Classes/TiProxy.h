...
//Rare exceptions to indicate a bug in the _biretreat2015 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BIRetreat2015 proxies.
 */
